    ...
    >
      ...
      <section className="px-5 py-20 sm:px-8 lg:px-12">
        <div className="grid gap-8 border border-white/15 p-6 sm:p-10 lg:grid-cols-3 lg:p-12">
          {["Credits", "Visuals", "Links"].map((item) => (
            <div key={item}>
              <p className="font-mono text-xs uppercase tracking-[0.28em] text-[#b9ff3b]">{item}</p>
              <p className="mt-4 text-lg leading-8 text-[#cfc5b8]">
                Every single, EP, and album connects the sound to the people, images, and links that built it.
              </p>
            </div>
          ))}
        </div>
