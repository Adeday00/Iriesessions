...
export const sessions: ContentItem[] = [
  ...
  },
  {
    ...
    image: "/media/collab-mohogany.jpg",
    summary:
  ...
  },
  {
    ...
    category: "session",
    kicker: "February 23, 2024 / Lagos, Nigeria",
    image: "/media/borders-soundscaping-01.jpg",
    summary:
    ...
    gallery: [
      ...
      { src: "/media/borders-soundscaping-06.jpg", label: "Performance archive" },
    ],
  },
  {
    title: "Culture Shock",
    ...
    image: "/media/culture-shock-01.jpg",
    summary:
  ...
  },
  {
    ...
    metadata: ["New York City", "NYFW", "Pop-up"],
  },
  {
    ...
    image: "/media/eventbrite-project-02.jpg",
    summary:
  ...
  {
    title: "IRIE Global Paris - Soho House",
    slug: "soho-house-paris",
    category: "session",
    kicker: "March 6, 2026 / Soho House Paris / France",
    image: "/media/session-paris-02.jpg",
    summary:
      "An intimate pre-launch gathering celebrating BORDERS: The Visualscaping Zine.",
    body:
      "In partnership with Soho House Paris, we curated an intimate pre-launch gathering celebrating the release of the BORDERS Visualscaping Zine. Curated by Aday, the evening brought together artists, founders, and members of Paris' creative community for meaningful conversation before the city came alive for the weekend. Soundtracked by Shifa Ligero and RONI, the gathering reflected IRIE's belief that the strongest communities are built long before the spotlight, through shared ideas, genuine relationships, and intentional spaces where culture can grow.",
    href: "/sessions/soho-house-paris",
    metadata: ["Paris", "Soho House", "Zine pre-launch"],
    gallery: [
  ...
  },
  {
    ...
    image: "/media/session-paris-01.jpg",
    summary:
      "The public launch of IRIE's debut publication through an immersive exhibition and live performance.",
    body:
      "Following an intimate preview at Soho House Paris, IRIE Global officially unveiled BORDERS: The Visualscaping Zine, the debut publication curated by founder Aday, ADAYLIVING. Held at Union de la Jeunesse Internationale, the public launch transformed the space into an immersive exhibition where photography, storytelling, and live performance converged. Exploring themes of art, diaspora, migration, collaboration, and creative freedom, BORDERS invited audiences to experience how sound can become image and how communities are formed across borders. The evening featured a live performance by Olga Kiav, whose work echoed the publication's themes of memory, movement, and identity, reinforcing IRIE's commitment to creating experiences where music, visual art, and cultural dialogue exist as one.",
    href: "/sessions/borders-visualscaping-zine-launch",
    metadata: ["Paris", "Publication launch", "Live exhibition"],
    gallery: [
      { src: "/media/irie-book-page-001.jpg", label: "Interior spread" },
      { src: "/media/zine-page.jpg", label: "Archive detail" },
      { src: "/media/book-product-01.jpg", label: "Printed object" },
    ],
  },
  {
